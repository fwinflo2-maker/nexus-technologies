 ...
 *
 *     'onfriq' => 0.97, 'stripe' => 0.99, 'noah' => 0.85, …
 *
 ...
 *
 * Vérifié en HTTP pendant l'audit : après 10 paiements mobile money `failed` sur 10
 ...
 * NOM d'affichage issu de la route (`Cashramp`), tandis que le reste du Core
 * raisonne en slug (`cashramp`). Vérifié en base : les deux formes coexistent.
 *
