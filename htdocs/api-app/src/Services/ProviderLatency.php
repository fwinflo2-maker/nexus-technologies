 ...
 * un provider mobile money et 20 à 30 s pour MTN MoMo — un écart mesuré de 20× — l'API
...
final class ProviderLatency
{
    ...
    private static function durationsFor(string $slug, ExecutionEnvironment $environment): array
    {
        ...
        try {
            ...
            // enregistre le NOM d'affichage de la route (« Cashramp »), le Core
            // raisonne en slug (« cashramp »). Ignorer l'une des formes
