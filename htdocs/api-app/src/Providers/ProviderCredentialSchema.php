...
final class ProviderCredentialSchema
{
    ...
    /**
     * Maplerad Issuing — https://maplerad.dev/docs/authentication
     * Secret Key Bearer. Public key documentée comme frontend (Checkout uniquement).
     *
     * @return list<CredentialDefinition>
     */
    private static function maplerad(): array
    {
        return [
            CredentialDefinition::secret(
                name: 'secret_key',
                ...
                required: true,
                usage: CredentialDefinition::USAGE_API_AUTH,
                justification: 'maplerad.dev/docs/authentication : « authorize API calls from your server, '
                    . 'pass your secret key as a bearer token ». Backend uniquement.',
                placeholder: 'clé secrète dashboard Maplerad'
            ),
            CredentialDefinition::secret(
                name: 'webhook_secret',
    ...
    private static function sumsub(): array
    {
        return [
            ...
            CredentialDefinition::identifier(
                name: 'level_name',
                label: 'Niveau KYC (WebSDK)',
                required: false,
                justification: 'Nom du niveau individuel Sumsub (dashboard → Verification levels). Défaut sandbox : id-and-liveness.',
                placeholder: 'id-and-liveness'
            ),
            CredentialDefinition::identifier(
                name: 'level_name_kyb',
                label: 'Niveau KYB (entreprise)',
                required: false,
                justification: 'Nom du niveau company Sumsub. Obligatoire pour les comptes Business.',
