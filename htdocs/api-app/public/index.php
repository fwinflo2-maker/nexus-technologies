...
use Nexus\Controllers\CompanyController;
...
// WebView Capacitor (APK / iOS) : origin = http(s)://localhost, y compris en production.
...
$router->get('/auth/google-config', [AuthController::class, 'googleConfig']);
...
$router->post('/control/staff/attachments', [StaffChatController::class, 'uploadAttachment']);
...
$router->delete('/control/staff/chats/{id}/messages/{messageId}', [StaffChatController::class, 'deleteMessage']);
...
// --- Registre entreprises (OpenCorporates) — KYB fallback / enrichissement ---
$router->get('/companies/search', [CompanyController::class, 'search']);
$router->get('/companies/{jurisdiction}/{number}', [CompanyController::class, 'show']);
$router->post('/kyb/registry/verify', [CompanyController::class, 'verify']);
...
$router->post('/users/me/close', [UserController::class, 'closeAccount']);
